...
powershell.exe -Command "Stop-Service -Name 'WireGuardTunnel\$${WG_ADAPTER_NAME}'" >> "$LOGFILE" 2>&1
sleep 5
powershell.exe -Command "Start-Service -Name 'WireGuardTunnel\$${WG_ADAPTER_NAME}'" >> "$LOGFILE" 2>&1
sleep 5
